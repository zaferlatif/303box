(() => {
  ...
  const SITE_VERSION='2026.08.26.6';
  const RELEASE_EPOCH='20260826-2960';
  ...
  function installSharedLayout(){
    ['siteShellLayout2401','siteShellLayout2404','siteShellLayout2405','siteShellLayout2406','siteShellLayout2407','siteShellLayout2408','siteShellLayout2409','siteShellLayout2410','siteShellLayout2411','siteShellLayout2601','siteShellLayout2602','siteShellLayout2603','siteShellLayout2604','siteShellLayout2605'].forEach(id=>document.getElementById(id)?.remove());
    const existing=document.getElementById('siteShellLayout2606');if(existing){document.head.appendChild(existing);return}
    const style=document.createElement('style');style.id='siteShellLayout2606';style.textContent=`
  ...
  function render(){
    installSharedLayout();installReleaseStyles();installPitchModel();installHardwareGuide();installHardwareFidelity();installMidiActionRow();syncRhythmTransferButton();installScopePolish();const lang=language();
  ...
  installBackgroundPlaybackPolicy();installPitchModel();installHardwareGuide();installHardwareFidelity();
