(() => {
  ...
  const SITE_VERSION='2026.08.26.5';
  const RELEASE_EPOCH='20260826-2950';
  ...
  function installSharedLayout(){
    ...
    const existing=document.getElementById('siteShellLayout2605');if(existing){document.head.appendChild(existing);return}
    const style=document.createElement('style');style.id='siteShellLayout2605';style.textContent=`
