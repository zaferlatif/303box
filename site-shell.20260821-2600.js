(() => {
  ...
  const SITE_VERSION='2026.08.24.4';
  const COPY={
  ...
  function installSharedLayout(){
    ...
    const existing=document.getElementById('siteShellLayout2404');
    if(existing){document.head.appendChild(existing);return}
    const style=document.createElement('style');style.id='siteShellLayout2404';style.textContent=`
