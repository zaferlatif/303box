(() => {
  ...
  addCss('midi-router', './midi-router.20260818-1600.css');
  ...
  load('./transport-fuse.20260818-1530.js')
    ...
    .then(() => load('./midi-router.20260818-1600.js'))
    ...
    .then(() => load('./generator-router.20260818-1600.js'))
