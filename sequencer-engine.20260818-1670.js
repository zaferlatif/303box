(() => {
  ...
  addCss('console-layout','./console-layout.20260818-1670.css');
  ...
  load('./cache-reset.20260818-1670.js')
    ...
    .then(()=>load('./bass-scope.20260818-1670.js'))
    ...
    .then(()=>load('./console-layout.20260818-1670.js'))
