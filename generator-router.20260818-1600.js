(() => {
  ...
  const PROFILES=[
    {intervals:[0,3,5,7,10],active:[8,11],kind:'jack'},
    {intervals:[0,1,3,5,7,10],active:[9,12],kind:'warehouse'},
    {intervals:[0,2,3,5,7,8,10],active:[8,12],kind:'hypnotic'},
    {intervals:[0,1,3,5,6,7,10],active:[10,13],kind:'techno'},
    {intervals:[0,3,5,6,7,10],active:[10,13],kind:'rave'}
  ];
  const MASKS=[
  ...
  function generateBass(){
    ...
    window.dispatchEvent(new CustomEvent('303box:bass-generated'));
  }
  ...
  window.__303boxGeneratorRouter={version:'1600',generateBass,generateDrums};
})();